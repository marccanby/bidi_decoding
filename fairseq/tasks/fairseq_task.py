...
class FairseqTask(object):
    ...
    def build_generator(
        ...
        try:
            from examples.bidi_decoding.bidi_generator import BidiSequenceGenerator
        except:
            from bidi_decoding.bidi_generator import BidiSequenceGenerator
        ...
        if seq_gen_cls is None:
            ...
            elif getattr(args, 'use_bidi_generator', False): # MARC
                seq_gen_cls = BidiSequenceGenerator
            else:
